  ...
  return (
    <footer className="footer">
      ...
      <div className="container">
        <div className="brand">
          <span className="logo">Riandika<span className="dot">.</span></span>
          <p className="tagline">Frontend Engineer crafting beautiful digital experiences.</p>
        </div>

        <nav className="nav">
          <h4 className="navTitle">Quick Links</h4>
        ...
        <div className="socialCol">
          <h4 className="navTitle">Connect</h4>
      ...
      <div className="bottom">
        <p className="copyright">
          &copy; {new Date().getFullYear()} I Nengah Riandika. All rights reserved.
        </p>
